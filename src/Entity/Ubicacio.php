...
use App\Repository\UbicacioRepository;
...
#[ORM\Entity(repositoryClass: UbicacioRepository::class)]
#[ApiResource(
    operations: [
        // new Get(),
        new GetCollection(),
...
class Ubicacio
{
     ...
     */
    #[ORM\OneToMany(mappedBy: 'ubicacio', targetEntity: Municipality::class)]
    ...
    public function removeMunicipality(Municipality $municipality): static
    {
        if ($this->municipalities->removeElement($municipality)) {
            ...
            if ($municipality->getUbicacio() === $this) {
                $municipality->setUbicacio(null);
            }
        }
